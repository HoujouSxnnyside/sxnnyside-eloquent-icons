...
This Code of Conduct applies to all project spaces: issues, pull requests, commit messages, and any other interaction tied to Sxnnyside Eloquent Icons (SEI).
